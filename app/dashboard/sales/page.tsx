...
import { Search, Eye, Edit, Trash2, FileText, Sheet, RotateCw, Calendar, X, Plus, Minus, DollarSign, CreditCard, MoreVertical } from 'lucide-react';
  ...
  const mockSales: Sale[] = [
    {
      ...
      createdBy: 'Admin',
      products: [
        { name: 'Nike Jordan', icon: '👟', qty: 2, purchasePrice: 2000, discount: 500, tax: 0, taxAmount: 0, unitCost: 0, totalCost: 1500 },
        { name: 'Apple Series 5 Watch', icon: '⌚', qty: 2, purchasePrice: 3000, discount: 400, tax: 0, taxAmount: 0, unitCost: 0, totalCost: 1700 },
        { name: 'Lobar Handy', icon: '🎮', qty: 2, purchasePrice: 2500, discount: 500, tax: 0, taxAmount: 0, unitCost: 0, totalCost: 2000 },
      ],
      payments: [
        { date: '19 Jan 2023', reference: 'INV/SL0101', amount: 1500, paidBy: 'Cash' },
      ],
      orderTax: 0,
      discount: 0,
      shipping: 0,
