...
export default function POSPage() {
  ...
  const products = [
    ...
    { id: '7', code: '8901234567890', name: 'Samsung Galaxy S24', mrp: 75000.00, stock: 15 },
    { id: '8', code: 'FD000001', name: 'Fresh Orange Juice', mrp: 150.00, stock: 100 },
    { id: '9', code: 'FD000002', name: 'Chocolate Brownie', mrp: 250.00, stock: 75 },
    { id: '10', code: 'FD000003', name: 'Chicken Sandwich', mrp: 180.00, stock: 60 },
    { id: '11', code: 'EL000001', name: 'Sony Headphones WH-1000XM5', mrp: 25000.00, stock: 12 },
    { id: '12', code: 'EL000002', name: 'Dell XPS 15 Laptop', mrp: 145000.00, stock: 6 },
    { id: '13', code: 'CL000001', name: 'Nike Air Max Shoes', mrp: 8500.00, stock: 30 },
    { id: '14', code: 'CL000002', name: 'Adidas Sports T-Shirt', mrp: 1200.00, stock: 80 },
    { id: '15', code: 'BK000001', name: 'Harry Potter Complete Set', mrp: 3500.00, stock: 20 },
    { id: '16', code: 'GR000001', name: 'Organic Tomatoes (1kg)', mrp: 60.00, stock: 200 },
    { id: '17', code: 'GR000002', name: 'Fresh Milk (1L)', mrp: 70.00, stock: 150 },
    { id: '18', code: 'SN000001', name: 'Lays Potato Chips', mrp: 20.00, stock: 300 },
    { id: '19', code: 'SN000002', name: 'Coca Cola (500ml)', mrp: 40.00, stock: 250 },
    { id: '20', code: 'AC000001', name: 'Leather Wallet', mrp: 1500.00, stock: 45 },
  ];
  ...
  const filteredCustomers = customerName.length > 0 && customerName !== 'Walk in Customer'
    ? customers.filter(c =>
  ...
  return (
    ...
    <div className="min-h-screen bg-gray-100">
      ...
      <div className="h-[calc(100vh-60px)]">
        {/* Billing Panel */}
        <div className="bg-white p-4 overflow-auto h-full">
          {/* Search Bar */}
