...
import { Search, Eye, Edit, Trash2, FileText, Sheet, RotateCw, X, FileCheck } from 'lucide-react';
    ...
    try {
      ...
      const mockAdjustments: StockAdjustment[] = [
        ...
        },
        {
          ...
          date: '25 Jul 2023',
          person: { name: 'Antonio Engle', initials: 'AE' },
          quantity: 120,
        },
        {
          id: '4',
          ...
          date: '28 Jul 2023',
          person: { name: 'Leo Kelly', initials: 'LK' },
          quantity: 130,
        },
        {
          id: '5',
          ...
          date: '24 Jul 2023',
          person: { name: 'Annette Walker', initials: 'AW' },
          quantity: 140,
        },
      ];
