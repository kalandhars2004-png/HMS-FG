      ...
      {showAddModal && (
        <GlobalModal
          onClose={() => {
            ...
            setCity(''); setState(''); setCountry(''); setPostalCode('');
            setCustomerStatus(true);
          }}
          title="Add Customer"
          subtitle="Customers are the people your business sells to."
            ...
            <div className="mb-6 flex items-center gap-4">
              ...
              <div className="flex flex-col gap-2">
                <label className="cursor-pointer">
                  <span className="px-6 py-2 bg-[#0F9291] text-white rounded-lg hover:bg-teal-700 inline-block">
                    Upload Image
                  </span>
                  <input
                    type="file"
              ...
              <div>
                ...
                <div className="flex items-center gap-3">
                  <button
                    ...
                    className="flex items-center gap-3 px-4 py-2 bg-white dark:bg-[#1E1E1E] border border-gray-300 dark:border-[#2A2A2A] rounded-xl hover:bg-gray-50 transition-colors"
                  >
                    <span className="text-sm font-medium text-gray-700 dark:text-gray-300">
                      {customerStatus ? 'Active' : 'Inactive'}
                    </span>
                    <div className={`relative w-10 h-5 rounded-full transition-colors ${
                      customerStatus ? 'bg-[#0F9291]' : 'bg-gray-300'
                    }`}>
